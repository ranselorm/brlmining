// src/pages/NorthKimberly.tsx
import React from "react";
import ProjectDetails from "../components/ProjectDetails";

const NorthKimberly: React.FC = () => {
  return (
    <>
      <ProjectDetails
        title="North Kimberly Diamond Project"
        ...
        prevProject={{ name: "Attwood", path: "/project/attwood" }}
        nextProject={{
          name: "Miminiska",
