  ...
  return (
    <section className="">
      <Hero
        ...
        description="BRL Mining Exploration Inc. is a Canadian mineral exploration company focused on advancing four district-scale gold projects in north-western Ontario, Canada. The company’s shares are listed on the TSX Venture Exchange trade under the symbol STRM."
      />
      <div className="w-full mx-auto px-4 sm:px-4 md:px-24 py-12 flex flex-col gap-y-20">
        <AboutCard
          title="Projects"
          description="BRL Mining Exploration is advancing four district-scale gold projects in
